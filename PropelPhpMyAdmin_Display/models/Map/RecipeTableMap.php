...
class RecipeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.RecipeTableMap';
     ...
     */
    const COL_IMAGE_URL = 'recipe.image_url';
     ...
     */
    const COL_DESCRIPTION = 'recipe.description';

    /**
     * the column name for the prep_time field
     */
    const COL_PREP_TIME = 'recipe.prep_time';

    /**
     * the column name for the total_time field
     */
    const COL_TOTAL_TIME = 'recipe.total_time';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ImageUrl', 'Name', 'Description', 'PrepTime', 'TotalTime', ),
        self::TYPE_CAMELNAME     => array('id', 'imageUrl', 'name', 'description', 'prepTime', 'totalTime', ),
        self::TYPE_COLNAME       => array(RecipeTableMap::COL_ID, RecipeTableMap::COL_IMAGE_URL, RecipeTableMap::COL_NAME, RecipeTableMap::COL_DESCRIPTION, RecipeTableMap::COL_PREP_TIME, RecipeTableMap::COL_TOTAL_TIME, ),
        self::TYPE_FIELDNAME     => array('id', 'image_url', 'name', 'description', 'prep_time', 'total_time', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ImageUrl' => 1, 'Name' => 2, 'Description' => 3, 'PrepTime' => 4, 'TotalTime' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'imageUrl' => 1, 'name' => 2, 'description' => 3, 'prepTime' => 4, 'totalTime' => 5, ),
        self::TYPE_COLNAME       => array(RecipeTableMap::COL_ID => 0, RecipeTableMap::COL_IMAGE_URL => 1, RecipeTableMap::COL_NAME => 2, RecipeTableMap::COL_DESCRIPTION => 3, RecipeTableMap::COL_PREP_TIME => 4, RecipeTableMap::COL_TOTAL_TIME => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'image_url' => 1, 'name' => 2, 'description' => 3, 'prep_time' => 4, 'total_time' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('description', 'Description', 'VARCHAR', true, 1024, null);
        $this->addColumn('prep_time', 'PrepTime', 'INTEGER', true, null, null);
        $this->addColumn('total_time', 'TotalTime', 'INTEGER', true, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(RecipeTableMap::COL_IMAGE_URL);
            $criteria->addSelectColumn(RecipeTableMap::COL_NAME);
            $criteria->addSelectColumn(RecipeTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(RecipeTableMap::COL_PREP_TIME);
            $criteria->addSelectColumn(RecipeTableMap::COL_TOTAL_TIME);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.image_url');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.description');
            $criteria->addSelectColumn($alias . '.prep_time');
